...
(function() {
	...
	*/
	ARController.getUserMedia = function(configuration) {
		...
		var videoConfig = { mandatory: constraints };
		if (configuration.cameraConfig && configuration.cameraConfig.video) {
			videoConfig = configuration.cameraConfig.video;
		}
	...
	*/
	...
	module.exports.artoolkit = artoolkit;
